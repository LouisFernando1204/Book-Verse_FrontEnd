    ...
    <>
                  ...
                  <div className="">
                    ...
                    >
                      ...
                      <svg
                        ...
                        className={
                          favoriteEBooks.some(
                            (fav) => fav.title === active.title
                          )
                            ? "w-4 h-4 text-yellow-300 ms-1 cursor-pointer"
                            : "w-4 h-4 text-gray-300 ms-1 cursor-pointer"
                        }
                        aria-hidden="true"
                    ...
                    >
                      by {truncate(active.author, 4, 4, 11) || <Skeleton />}
                    </motion.p>
                  </div>
                  <motion.div
                    layout
      ...
      >
        {isAllEBook || isBookmark ? (
          (isAllEBook ? filteredEBooks : favoriteEBooks).filter((ebook) =>
            [
              ebook.title,
              ebook.author,
              ebook.genre,
