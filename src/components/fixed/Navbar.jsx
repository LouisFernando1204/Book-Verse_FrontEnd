            ...
            <Link to="/">
              <div className="flex flex-row space-x-2 flex-shrink-0 items-center">
                <img
                  ...
                  className="w-12"
                />
                <span className="hidden md:flex italic font-bold text-lg font-mono">Book-Verse</span>
              </div>
            </Link>
              ...
              <div className="flex space-x-4">
                {navigation.map((item) => (
                  <Link
                    ...
                    className={classNames(
                      item.current ? 'bg-gradient-to-b from-gray-900 to-gray-700 text-white hover:shadow-xl transition duration-200' : 'text-gray-900 hover:bg-gradient-to-b hover:from-gray-900 hover:to-gray-700 hover:text-white hover:shadow-xl hover:transition hover:duration-200',
        ...
        <div className="space-y-1 px-2 pb-3 pt-2">
          {navigation.map((item) => (
            <DisclosureButton
              ...
              aria-current={item.current ? 'page' : undefined}
              className={classNames(
                item.current ? 'text-center bg-gradient-to-b from-gray-900 to-gray-700 text-white hover:shadow-xl transition duration-200' : 'text-center text-gray-900 hover:bg-gradient-to-b hover:from-gray-900 hover:to-gray-700 hover:text-white hover:shadow-xl hover:transition hover:duration-200',
