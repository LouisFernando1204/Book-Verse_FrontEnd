        ...
        <main className="h-screen w-full flex flex-col items-center justify-center px-6 py-24 sm:py-32 lg:px-8">
            <div className="text-center">
                <motion.p
                    ...
                    className="text-base font-semibold text-gray-900">404</motion.p>
                <motion.h1
                    initial={{
                        opacity: 0,
                        y: 20,
                    ...
                    className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Page not found</motion.h1>
                <motion.p
                    initial={{
                        opacity: 0,
                        y: 20,
                    ...
                    className="mt-6 text-base leading-7 text-gray-600">Sorry, we couldn’t find the page you’re looking for.</motion.p>
                <motion.div
                    initial={{
                        opacity: 0,
                        y: 20,
